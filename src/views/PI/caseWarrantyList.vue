		...
		createList() {
			...
			if(this.checkDateWarranty){
				...
				caseList.forEach(caseSpec => {
					caseSpec.CaseDate = moment(caseSpec.CaseDate).isValid() ? moment(caseSpec.CaseDate).format("YYYY/MM/DD HH:mm:ss") : "";
					caseSpec.DateDeadline = moment(caseSpec.DateDeadline).isValid() ? moment(caseSpec.DateDeadline).format("YYYY/MM/DD HH:mm:ss") : "";
					caseSpec.DateCompleted = moment(caseSpec.DateCompleted).isValid() ? moment(caseSpec.DateCompleted).format("YYYY/MM/DD HH:mm:ss") : "";
					caseSpec.DateWarranty = moment(caseSpec.DateWarranty).isValid() ? moment(caseSpec.DateWarranty).format("YYYY/MM/DD HH:mm:ss") : "";
				})
